...
var jwtCheck = jwt({
    ...
    algorithms : ['RS256'],
    // issuer : 'sbcharjee.auth0.com', fuck man this took me 2 hours to debug Bhenchod
...
// If we don't get correct credentials, we'll return appropriate messages
...
// Implementing the movies API endpoints
app.get('/movies', function (req, res) {

	// Get a list of movies and there review scores
	var movies = [
  ...
  // Sending list as a JSON array
  res.json(movies);
});

// Implementing the reviewer API endpoints
...
// Implementing the publication API endpoints
...
// Implementing the pending API endpoints
